...
public class GPUImageRGBDilationFilter extends GPUImageTwoPassTextureSamplingFilter {
    ...
    public static final String FRAGMENT_SHADER_1 = "#extension GL_OES_EGL_image_external : require\n" +
    ...
    public static final String FRAGMENT_SHADER_2 = "#extension GL_OES_EGL_image_external : require\n" +
            "precision highp float;\n" +
                    "\n" +
                    "varying vec2 centerTextureCoordinate;\n" +
                    "varying vec2 oneStepPositiveTextureCoordinate;\n" +
    ...
    public static final String FRAGMENT_SHADER_3 = "#extension GL_OES_EGL_image_external : require\n" +
            "precision highp float;\n" +
                    "\n" +
                    "varying vec2 centerTextureCoordinate;\n" +
                    "varying vec2 oneStepPositiveTextureCoordinate;\n" +
    ...
    public static final String FRAGMENT_SHADER_4 = "#extension GL_OES_EGL_image_external : require\n" +
            "precision highp float;\n" +
                    "\n" +
                    "varying vec2 centerTextureCoordinate;\n" +
                    "varying vec2 oneStepPositiveTextureCoordinate;\n" +
