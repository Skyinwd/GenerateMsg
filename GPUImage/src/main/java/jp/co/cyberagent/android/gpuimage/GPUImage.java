...
public class GPUImage {  
    ...
    private GLSurfaceView mSecondGlSurfaceView;
    private GPUImageFilter mFilter;
    private Bitmap mCurrentBitmap;
    private ScaleType mScaleType = ScaleType.CENTER_CROP;
    private static final String TAG = "GENERATE_GPUIMAGE";
    ...
    //Sets second GLSurfaceView
    public void setSecondGLSurfaceView(final GLSurfaceView view) {
        mSecondGlSurfaceView = view;
        mSecondGlSurfaceView.setEGLContextClientVersion(2);
        mSecondGlSurfaceView.setRenderer(mRenderer);
        mSecondGlSurfaceView.setRenderMode(GLSurfaceView.RENDERMODE_WHEN_DIRTY);
        //mSecondGlSurfaceView.requestRender();
    }
    ...
    public void requestRender() {
        ...
        if (mSecondGlSurfaceView != null) {
            mSecondGlSurfaceView.requestRender();
        }
    }

    //added here to resolve issue with certain device's front-facing camera not taking up
    // the whole screen
...
//        mGlSurfaceView.requestLayout();
    ...
    public void setUpCamera(final Camera camera, final int degrees, final boolean flipHorizontal, final boolean flipVertical) {
        ...
        if(mSecondGlSurfaceView != null) mSecondGlSurfaceView.setRenderMode(GLSurfaceView.RENDERMODE_CONTINUOUSLY);
    ...
    public void setUpAudioThread(final AudioThread thread){
        mRenderer.setUpAudioRecord(thread);
    }
    ...
    /**
     * Deletes the current video.
     */
    public void deleteVideo(){
        getVideoOutputFile().delete();
    }

    /**
     * Start recording the current video.
     */
    public void startRecording(int width, int height, int bitrate){
        mRenderer.setmRecordingBitrate(bitrate);
        mRenderer.setmRecordingWidth(width);
        mRenderer.setmRecordingHeight(height);
    ...
    public void setVideo(final Uri uri){
        mRenderer.setVideo(mContext, uri);
    }

    public void setAndPlayVideo(final Uri uri){
        mRenderer.setVideo(mContext, uri);
        startVideo();
    }
    ...
    public Bitmap getBitmapWithFilterApplied(final Bitmap bitmap) {
        Log.d("toycamera", "applying filter");
        if (mGlSurfaceView != null) {
            mRenderer.deleteImage();
     ...
     */
    public Bitmap captureSurfaceView() {
    ...
    public File getVideoOutputFile(){
        return mRenderer.getVideoOutputFile();
    }
